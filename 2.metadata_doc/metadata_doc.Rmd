...
p_first_name <- c("Alex", "")
p_middle_in <- c("", "")
p_last_name <- c("Wegmann", "")
p_organization <- c("The Nature Conservancy", "")
p_email <- c("alex.wegmann@tnc.org", "")
p_orcid <- c("", "")
p_role <- c("contact", "")
...
**Recommended**. The easier it is for people to reuse your data, the more likely it is that your data will be reused.
...
Description <- c("08/04/2004", "04/07/2008", "Completed")
...
EMLassemblyline::template_table_attributes(
  path = path_templates,
  data.path = path_data,
  data.table = "osp2004.csv")

## reading text into a data frame
data_attributes <- read.delim2(here::here("EML/data_attributes/attributes_osp2004.txt")) %>% 
